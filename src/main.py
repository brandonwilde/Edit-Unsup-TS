...
# 		sample(test_complex, test_simple, output_lang, tag_lang, dep_lang, lm_forward, lm_backward, output_embedding_weights, idf, unigram_prob)
	...
	idf, unigram_prob, output_lang, tag_lang, dep_lang, split_simple, split_complex, output_embedding_weights, tag_embedding_weights, dep_embedding_weights = prepareDataSingle(config['embedding_dim'], config['freq'], config['ver'], config['dataset'], config['operation'], config['set'])
...
# 	config['freq'], config['ver'], config['dataset'], config['operation'])
	...
	from tree_edits_beam import *
	sample(split_complex, split_simple, output_lang, tag_lang, dep_lang, lm_forward, lm_backward, output_embedding_weights, idf, unigram_prob)
